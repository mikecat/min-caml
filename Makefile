...
SOURCES = float.c type.ml id.ml m.ml vm.ml s.ml \
syntax.ml parser.mly lexer.mll duplicate.mli duplicate.ml \
typing.mli typing.ml merge.mli merge.ml kNormal.mli kNormal.ml \
